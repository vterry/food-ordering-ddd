...
- *Software Architecture: The Hard Parts* (Neal Ford) - Trade-offs e Granularidade.
- *Building Microservices* (Sam Newman) - Acoplamento e Coesão.
- *Building Event-Driven Microservices* (Adam Bellemare) - Topologias e Schemas.
...
**REGRA CRÍTICA**: NÃO gere código de solução completa nesta fase.
