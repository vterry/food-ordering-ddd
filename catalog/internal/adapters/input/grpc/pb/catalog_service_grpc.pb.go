...
const (
	CatalogService_ValidateRestaurantAndItems_FullMethodName = "/catalog.CatalogService/ValidateRestaurantAndItems"
)
...
func _CatalogService_ValidateRestaurantAndItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateRestaurantAndItemsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatalogServiceServer).ValidateRestaurantAndItems(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CatalogService_ValidateRestaurantAndItems_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).ValidateRestaurantAndItems(ctx, req.(*ValidateRestaurantAndItemsRequest))
	}
...
var CatalogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ValidateRestaurantAndItems",
			Handler:    _CatalogService_ValidateRestaurantAndItems_Handler,
		},
	},
