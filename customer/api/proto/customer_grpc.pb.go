...
type CustomerServiceClient interface {
	GetCustomerByID(ctx context.Context, in *GetCustomerRequest, opts ...grpc.CallOption) (*CustomerResponse, error)
}
...
func (c *customerServiceClient) GetCustomerByID(ctx context.Context, in *GetCustomerRequest, opts ...grpc.CallOption) (*CustomerResponse, error) {
...
type CustomerServiceServer interface {
	GetCustomerByID(context.Context, *GetCustomerRequest) (*CustomerResponse, error)
...
func (UnimplementedCustomerServiceServer) GetCustomerByID(context.Context, *GetCustomerRequest) (*CustomerResponse, error) {
...
func _CustomerService_GetCustomerByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).GetCustomerByID(ctx, req.(*GetCustomerRequest))
	}
